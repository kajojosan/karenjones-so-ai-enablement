...
#### Key Quotes
Verbatim quotes from participants that are particularly impactful, revealing,
or useful for briefs and stakeholder alignment. Look for:
- Statements that quantify a problem ("Only 15-20% of donations are usable")
- Vision statements or aspirational descriptions of what they want
- Emotional or emphatic statements that reveal priority and passion
- Concise descriptions of pain points in the speaker's own words

Format each quote with attribution and approximate timestamp:
> "Only 15-20% of the donations we receive are actually usable for the
> families we serve." — Mike Komola (~min 25)

Guidelines:
- Use the speaker's exact words (verbatim, not paraphrased)
- Include 2-4 quotes per feature (more if the discussion was rich)
- Prioritize quotes that would be compelling in a brief, deck, or funding pitch
- Note approximate timestamp for easy verification against recording

#### Stakeholder Alignment
Track who advocated, who raised concerns, and who was notably absent from
each feature discussion. Read for tone and emphasis, not just content:
...
Use these labels:
- **Champions** — actively advocated, showed enthusiasm, returned to the topic
- **Supportive** — agreed when raised, offered constructive additions
- **Concerns raised** — flagged risks, constraints, or reservations
- **Not heard from** — participants who were silent or disengaged on this topic

This is critical for follow-up: knowing who to involve as a champion vs.
who needs more convincing shapes your next conversation.
...
[Best 5-8 quotes across all features, ordered by impact/usefulness for briefs]

## Stakeholder Summary
[Per-person summary: what they championed, what concerned them, overall energy level]
```
